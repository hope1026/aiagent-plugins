...
| [승인된 component grammar로 개별 Visual Docs를 생성할 때 UI 디자인 skill과 수동 HTML fragment·문서별 template·CSS·script를 사용하지 않고 Semantic IR과 composition을 공통 renderer에 전달한다. Shell·component·profile·planner tooling 변경에만 `web-app-design`을 적용한다.](../../specs/review-viewer-lifecycle/adaptive-presentation-and-navigation.md#승인된-component-grammar로-개별-visual-docs를-생성할-때-ui-디자인-skill과-수동-html-fragment문서별-templatecssscript를-사용하지-않고-semantic-ir과-composition을-공통-renderer에-전달한다-shellcomponentprofileplanner-tooling-변경에만-web-app-design을-적용한다) | Acceptance | 6 |
...
- [승인된 component grammar로 개별 Visual Docs를 생성할 때 UI 디자인 skill과 수동 HTML fragment·문서별 template·CSS·script를 사용하지 않고 Semantic IR과 composition을 공통 renderer에 전달한다. Shell·component·profile·planner tooling 변경에만 `web-app-design`을 적용한다.](../../specs/review-viewer-lifecycle/adaptive-presentation-and-navigation.md#승인된-component-grammar로-개별-visual-docs를-생성할-때-ui-디자인-skill과-수동-html-fragment문서별-templatecssscript를-사용하지-않고-semantic-ir과-composition을-공통-renderer에-전달한다-shellcomponentprofileplanner-tooling-변경에만-web-app-design을-적용한다)
