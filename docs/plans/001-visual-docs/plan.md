...
| [Forge 원문의 시각화와 관리형 문서 요청에는 `visual-docs`를 유지하고 공용 renderer의 UI 변경은 `verifying-work`의 UI 검증 지침으로 확인해야 한다.](../../specs/forge-ui-design-skill-separation/forge-ui-design-skill-separation.md#forge-원문의-시각화와-관리형-문서-요청에는-visual-docs를-유지하고-공용-renderer의-ui-변경은-verifying-work의-ui-검증-지침으로-확인해야-한다) | Requirement | 1, 4, 6 |
...
**Governing statements:**
- [Forge 원문의 시각화와 관리형 문서 요청에는 `visual-docs`를 유지하고 공용 renderer의 UI 변경은 `verifying-work`의 UI 검증 지침으로 확인해야 한다.](../../specs/forge-ui-design-skill-separation/forge-ui-design-skill-separation.md#forge-원문의-시각화와-관리형-문서-요청에는-visual-docs를-유지하고-공용-renderer의-ui-변경은-verifying-work의-ui-검증-지침으로-확인해야-한다)
