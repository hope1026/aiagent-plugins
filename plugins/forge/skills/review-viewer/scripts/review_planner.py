"""Validated presentation planning for requested Review Viewers."""
...
class ViewContext:
    ...
    def __post_init__(self) -> None:
        if self.mode not in MODES:
            raise ValueError(f"unsupported review mode: {self.mode}")
    ...
    for component_id in component_ids:
        ...
        components.append(
            ComponentPlan(
                ...
                disclosure="collapsed" if component_id == "source-detail" else "open",
            )
        )
