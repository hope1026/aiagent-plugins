...
grep -q '13 user-execution skills' "$ROOT/README.md"
grep -q '| `creating-agent-extensions` |' "$ROOT/README.md"
grep -q 'Codex, Claude Code, and Antigravity' "$ROOT/.agent-runbooks/maintaining-forge/README.md"
grep -q '.agent-extensions/' "$ROOT/.agent-runbooks/maintaining-forge/references/portability-rules.md"
grep -q 'manage_extension.py" --help' "$ROOT/scripts/validate.sh"
