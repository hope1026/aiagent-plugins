...
VIEWER="$ROOT/plugins/forge/skills/visual-docs/SKILL.md"
...
assert_has 'Visual Docs.*web-app-design' "$ROUTER"
assert_has 'visual-docs' "$ROUTER"
assert_not_has 'spec-viewer' "$ROUTER"
assert_has 'Visual Docs tooling.*web-app-design|visual-docs tooling.*web-app-design' "$APP"
assert_not_has 'Spec Pages tooling' "$APP"
assert_has 'fixed Visual Docs generation' "$APP"
assert_has 'fixed Visual Docs generation' "$SITE"

assert_has '\| `web-app-design` \|' "$MAINTAINER"
assert_has '\| `website-design` \|' "$MAINTAINER"
assert_has '\| `visual-docs` \|' "$MAINTAINER"
